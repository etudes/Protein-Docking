...
public class PsuedoTestCase {
	...
	public PsuedoTestCase(PsuedoProteinStruct ps1, PsuedoProteinStruct ps2) {
		...
		this.ps1 = ps1;
		this.ps2 = ps2;
		this.newps1 = ps1.trans(-ps1.getXCoordCent(), -ps1.getYCoordCent(), -ps1.getZCoordCent());
		this.newps2 = ps2.trans(-ps1.getXCoordCent(), -ps1.getYCoordCent(), -ps1.getZCoordCent());
...
System.out.println(vanDerWaalsE);
	...
	public PsuedoProteinStruct getPS2() {
		return ps2;
	}
	public PsuedoProteinStruct getNewPS1() {
		return newps1;
	}
